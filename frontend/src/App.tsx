    ...
    return (
        <div className="min-h-screen text-white flex flex-col" style={{
            ...
            <div className="max-w-7xl mx-auto px-4 w-full flex flex-col flex-1">
                <div className={`flex flex-col items-center justify-center ${data ? 'py-12' : 'min-h-screen'}`}>
                    <p className="text-blue-400 text-sm font-semibold tracking-widest uppercase mb-2">NASA NeoWs API</p>
                    <h1 className="text-5xl font-bold tracking-tight mb-2">Asteroid Tracker</h1>
                    <p className="text-gray-400 mt-3 text-lg mb-8">Track near-Earth objects and potential hazards</p>
